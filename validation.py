...
def validation(folder_address, model_folder):
    import yaml
...
model_address = '/Users/cookie/dev/instrument_classifier/model_results/m_loudener/lr_0.0003_epochs_2_20240307-000159/'
...
def yaml_test(destination_address):

    import yaml

    name = 'yaml_test'

    yaml_input = [{'sports' : ['soccer', 'football', 'basketball', 'cricket', 'hockey', 'table tennis']}, {'countries' : ['Pakistan', 'USA', 'India', 'China', 'Germany', 'France', 'Spain']}]
